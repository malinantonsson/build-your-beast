...
gulp.task('default', (config.production ? ['modernizr', 'scripts', 'styles'] : ['modernizr', 'scripts', 'styles', 'pages', 'watch']));
...
gulp.task('pages', ['clean:pages'], pages);
